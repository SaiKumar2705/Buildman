...
import com.buildman.buildman.adapter.Issues_Status_Adapter;
import com.buildman.buildman.adapter.Issues_Status_Expandable_Adapter;
...
public class Issues_Status extends Activity {		
	 DatabaseHandler db;
...
//	 private ExpandableListView mExpandableList;
	 ...
	 @Override
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.issues_status);
...
//	 			Toast.makeText(getApplicationContext(), "go back", Toast.LENGTH_SHORT).show();
	 		 Intent i=new Intent(Issues_Status.this,Home.class);		
	 		startActivity(i);
	 		finish();
	 		return;
	 }
...
//	      get selected site_id from usersite class    
		...
		LinearLayout relative = (LinearLayout) findViewById(R.id.listview_linearlayout_issues_status);
		...
		mExpandableList.setAdapter(new Issues_Status_Adapter(Issues_Status.this,arrayChildren));
		mExpandableList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if(model!=null)
				{
					...
					Intent i=new Intent(Issues_Status.this,Issues_Status_Description.class);
...
//	             mExpandableList.setAdapter(new Issues_Status_Expandable_Adapter(Issues_Status.this,arrayParents));
...
//	    	             			Status_Child_Model child_model =  arrayParents.get(groupPosition).getArrayChildren().
//	    						 									get(childPosition);
...
//	    		});
	...
	//  get party_id and org_id fm Login table which always have only 1 row
     db=new DatabaseHandler(Issues_Status.this);    
	...
	private void getIds() {
		...
		mExpandableList = (ListView)findViewById(R.id.expandablelist_issues_status);

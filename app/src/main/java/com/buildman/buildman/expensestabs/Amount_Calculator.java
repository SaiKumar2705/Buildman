...
public class Amount_Calculator extends Activity {
	...
	ok.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent i=new Intent(Amount_Calculator.this,Income_Expense_Description.class);
			
//			i.putExtra("calculated_value_amt", final_value_result);
			SharedPreferences calculated_amt_pref = Amount_Calculator.this.getSharedPreferences("Calculated_amt_MyPrefs", Context.MODE_PRIVATE);		
		  	SharedPreferences.Editor calculated_amt_edit = calculated_amt_pref.edit();	
		  	calculated_amt_edit.putString("Calculated_amt_KEY_PREF",final_value_result);	
		  	calculated_amt_edit.commit();
			startActivity(i);
		}
	});

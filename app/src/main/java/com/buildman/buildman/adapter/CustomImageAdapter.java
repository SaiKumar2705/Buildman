...
//import com.buildman.buildman.model.GetSet;
//import com.buildman.buildman.statustabs.Issues_Status_Description;
//
...
//            Bitmap icon = BitmapFactory.decodeResource(_c.getResources(), R.drawable.ic_launcher);
...
//                ((Sample) _c).captureImage(dataSet.getListItemPosition(), dataSet.getLabel() + "" + dataSet.getSubtext());
//            }
//        });
//

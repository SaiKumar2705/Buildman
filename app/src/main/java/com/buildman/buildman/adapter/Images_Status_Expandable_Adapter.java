...
public class Images_Status_Expandable_Adapter extends BaseExpandableListAdapter {
	 
		Context context;
	    private LayoutInflater inflater;
	    private ArrayList<Status_Model> mParent;
	    DatabaseHandler db; 
	    public Images_Status_Expandable_Adapter(Context context, ArrayList<Status_Model> parent){
...
//	         return chList.get(childPosition);
	    ...
	    public View getGroupView(int groupPosition, boolean b, View view, ViewGroup viewGroup) {
	        ...
	        if (view == null) {
	            view = inflater.inflate(R.layout.images_status_row, viewGroup,false);
	        } 
	               
	        TextView mMain_task_name_Txv = (TextView) view.findViewById(R.id.taskname_images_status_row);
	        
	         mMain_task_name_Txv.setText(getGroup(groupPosition).toString());
	        
	        TextView start_date_Txv = (TextView) view.findViewById(R.id.startdate_images_status_row);
	        start_date_Txv.setText(mParent.get(groupPosition).getStart_Date());
	        
	        TextView qty_completion_Txv = (TextView) view.findViewById(R.id.qty_images_status_row);
	        ...
	        TextView units_Txv = (TextView) view.findViewById(R.id.units_images_status_row);
	    ...
	    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view, ViewGroup viewGroup) {
	        ...
	        if (view == null) {
	            view = inflater.inflate(R.layout.images_status_child_row, viewGroup,false);
	        }
	 
	        TextView textView = (TextView) view.findViewById(R.id.sub_task_name_images_status_child_row);
	        TextView images_symbol_txv = (TextView) view.findViewById(R.id.images_symbol_images_status_child_row);
	        TextView balc_qty_txv = (TextView) view.findViewById(R.id.balance_qty_images_status_child_row);
	        TextView completed_qty_txv = (TextView) view.findViewById(R.id.qtycompleted_images_status_child_row);
	        TextView total_qty_txv = (TextView) view.findViewById(R.id.totalqty_images_status_child_row);
...
//	        calculating balc_qty
	        ...
	        ((Images_Status)context).check_Images_ExistsIn_Folder();
//	        setting images symbol 
	        db = new DatabaseHandler(context);
	        List<Status_Model> list = db.find_SiteID_WorkMasterId_ProjectImagesList(child.getSite_ID_Child(),
	        		child.getPRJ_EST_WorkMaster_ID_Child());  
	        if(list.size()==0){
	        	
	        	images_symbol_txv.setText("");
	        	images_symbol_txv.setBackgroundResource(0);
	        }else {
	        	images_symbol_txv.setText(String.valueOf(list.size()));
	        	images_symbol_txv.setBackgroundResource(R.drawable.circle_border);
	        }
